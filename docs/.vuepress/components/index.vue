<template>
  <div class="index-wrap">
    <div
      :style="{'background-image':`url(${$Source}/index/bg${bannerBg}.jpg)`}"
      class="banner-wrap"
    >
      ...
      <aside>
        <div class="card-wrap card-info">
          <div class="avatar-info">
            <el-avatar :size="80">
              <img src="http://cdn.fnkc.xyz/index/avatar.jpg" />
            </el-avatar>
            <p>FUTURECHEN</p>
          </div>
          <div class="data-info">
          ...
          <div class="social-info">
            ...
            <a href="mailto:1283482593@qq.com">
        ...
        <div class="card-wrap card-love">
          <div class="avatar-info">
            <img alt src="http://cdn.fnkc.xyz/life/diary/2020-05-20-1.jpg" />
            <i class="shni shn-heart-fill"></i>
            <img alt src="http://cdn.fnkc.xyz/life/diary/2020-05-20-2.jpg" />
          </div>
...
export default {
  ...
  mounted() {
    ...
    this.bannerBg = Math.floor(Math.random() * 7 + 1)
    this.loveTime()
    this.getInfo()
  },
  destroyed() {
  ...
  methods: {
    ...
    openAlipay() {
      this.$notify({
        ...
        message:
          `<img src="${$Source}/index/alipay_ercode.jpg" style="width:200px"/>`,
        duration: 0,
